...
void text_v_func()
{
    cout << tm_pic << "TME - Turing Machine Emulator V1.2\n\n"
         << "(c)"
         << "Bulak A.S." << endl;
}
...
{
    cout << "CTRL+C OR CTRL+D TO CLOSE" << endl << endl << "TME - Turing Machine Emulator V1.2\n\n";
    ...
    cout << "The first argument is positional and should be either \" - v \" or the path of the interpretation file."
         << endl
         << endl
